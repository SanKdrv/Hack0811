        ...
        data = {
            ...
            "messages": [
                    {"role": "system", "content": 'Вам на вход подаётся текст и тема сообщения в тех. поддержку. Вам нужно '
                                                  ...
                                                  'ответ необходимо вывести одним словом или определением. Выберите '
                                                  'только одну точку отказа. Укажите ответ ТОЧНО КАК УКАЗАНО В '
                                                  'МАССИВЕ, ваш ответ будет использоваться в коде программы. Если точка'
        ...
        data = {
            ...
            "messages": [
                {"role": "system", "content": 'Вам на вход подаётся текст и тема сообщения в тех. поддержку. Вам нужно '
                                              ...
                                              'ответ необходимо вывести одним словом или определением. Укажите ответ '
                                              'ТОЧНО КАК УКАЗАНО В МАССИВЕ, ваш ответ будет использоваться в коде '
                                              'программы.'
